...
namespace SC90.Bot.Extensions
{
    ...
    {
        public static void ConfigureServices(this IServiceCollection serviceCollection, params string[] assemblyFilters)
        {
            ...
            ConfigureServices(serviceCollection, assemblies);
        }

        public static void ConfigureServices(this IServiceCollection serviceCollection, params Assembly[] assemblies)
        {
            ...
            var configurators = 
                GetTypesImplementing<IServicesConfigurator>(assemblies)
                .Where(obj => obj.Name.Equals("ConfigureServices", StringComparison.Ordinal));

            foreach (var type in configurators)
            {
                var configurator = Activator.CreateInstance(type) as IServicesConfigurator;
